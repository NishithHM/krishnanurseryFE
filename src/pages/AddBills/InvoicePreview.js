...
export const InvoicePreview = ({ showPreview, onClose, clientDetails, cartData, children, cartResponse, invoiceNumber, setInvoiceNumber }) => {
  ...
  return (
    <Modal opened={showPreview} onClose={onClose} centered size="auto" closeOnClickOutside={false} closeOnEscape={true}>
      ...
      <div className={styles.modalContent} id="modal-print-section" ref={componentRef}>
